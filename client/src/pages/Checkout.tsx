  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!razorpayKeyResponse.ok || razorpayKeyResponse.status === 503) {
        ...
        // Payment gateway logging removed for production
      ...
      paymentObject.on('payment.failed', async function (response: any) {
        // Payment failure logging removed for production
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="pt-4 border-t">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground mb-4">
                      <input type="checkbox" id="terms" required className="h-4 w-4 rounded border-zinc-300" />
                      <label htmlFor="terms">
                        I agree to the <a href="/terms" className="text-orange-600 underline">Terms & Conditions</a> and <a href="/privacy" className="text-orange-600 underline">Privacy Policy</a>
                      </label>
                    </div>
                  </div>
